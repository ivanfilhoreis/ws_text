...
def get_representations():
    ...
    dic_tw = {'TF-Bert'       : bertVectorizer(language='pt_core_news_sm', bert_model = 'bert-base-multilingual-cased'),
              #'TF-Distilbert' : bertVectorizer(language = 'pt_core_news_sm', bert_model = 'distilbert-base-multilingual-cased'),
              #'TF-Bert-PtBR'  : bertVectorizer(language = 'pt_core_news_sm', bert_model = 'neuralmind/bert-base-portuguese-cased'),
